...
APP_ID=12625817 #my.telegram.org
APP_HASH='114b6234ce7a1ab51f1ad356f43e5cff' #my.telegram.org
BOTT=''#@botfather
...
def staat(qq):
  ...
  data = {
    ...
    "caption": "ශ්‍රී ලංකාවේ කොරෝනා තතු එසැනින් දැනගන්න. @SLCovid19Bot Group එකට Add කරගත් පසු ස්වයංක්‍රියව නවතම කොරෝනා තතු ලබාගත හැක.  වැඩි විස්තර සදහා /help භාවිතා කරන්න.     ~ @Black Alpha | @Razah ",
    "parse_mode": "HTML",
    "reply_markup": {
        "inline_keyboard": [
            [
